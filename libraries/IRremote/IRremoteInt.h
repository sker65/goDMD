...
#if defined(__AVR__) // - now the various definitions for AVR timers
...
#endif // end of the various timer interrupt definitions for the AVR boards
...
// this means disable reacording interupt 
#define TIMER_DISABLE_INTR { \
	ConfigIntTimer2( T2_INT_OFF ); \
}

#define CLEAR_INTERRUPT() mT2ClearIntFlag()

// will be used by enableIrOut to get a fixed frequency when sending
// IR pulses for the various protocols
#define TIMER_CONFIG_KHZ(khz)

// this will be used for receiving
...
// will be called at the begin of the ISR
#define TIMER_RESET
